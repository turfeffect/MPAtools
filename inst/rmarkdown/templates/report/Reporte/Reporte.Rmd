...
*Este documento fue generado por el paquete `MPAtools`, uno de los entregables del grupo de [TURFeffect](www.turfeffect.org). Los resultados presentados son una versión preliminar del softwer que se está desarrollando, y no recomendamos la toma de decisiones basado en la información aquí presentada*
...
```{r}
ggplot(arrM, aes(x = Ano, y = Peso/1000)) +
  geom_point() +
...
```{r}
ggplot(arrP, aes(x = Ano, y = Peso/1000)) +
  geom_point() +
...
```{r}
ggplot(arrL, aes(x = Ano, y = Peso/1000)) +
  geom_point() +
...
ggplot(ingG, aes(x = Ano, y = Valor/1000)) +
  geom_point()  +
...
```{r}
ggplot(ingM, aes(x = Ano, y = Precio/1000)) +
  geom_point() +
...
```{r}
ggplot(ingP, aes(x = Ano, y = Precio/1000)) +
  geom_point() +
...
```{r}
ggplot(ingL, aes(x = Ano, y = Precio/1000)) +
  geom_point() +
...
*La información de gobernanza se presenta con propósitos de realizar el ejercicio; de ninguna manera representa una evaluación que pueda utilizarse para recomendaciones.* 
