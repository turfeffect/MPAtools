...
*Este documento fue generado por el paquete [`MPAtools`](https://github.com/turfeffect/MPAtools), uno de los entregables del grupo de [TURFeffect](www.turfeffect.org). Los resultados presentados son una versión preliminar del softwer que se está desarrollando, y no recomendamos la toma de decisiones basado en la información aquí presentada*
