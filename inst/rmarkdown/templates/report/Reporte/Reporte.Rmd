...
![Negativo y significativo](red.jpg)
![Negativo y no significativo](orange.jpg)
![Sin cambios](yellow.jpg)
![Positivo y no significativo](green1.jpg)
![Positivo y significativo](green2.jpg)
...
stargazer(turfeffect(Np, reserve = params$reserva, control = params$control), dep.var.labels = "Densidad (org / transecto)", type = "html", dep.var.caption = "", report = "vc*", single.row = T, omit.stat = c("adj.rsq", "n"), digits = 2, df = F, covariate.labels = c("Ano", "**Zona**", "Constante"), star.char = "+")
